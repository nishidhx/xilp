...
Saerch an array and return the indices of the elements that get match. We use ***where()*** method to search into a numpy array. We can give the parameter which elements makes the condition satisfy will return the 